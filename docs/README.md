...
`BOT_INIT_PROMPT` | `''` | AI 助理的初始提示詞，用來設定使用者或 AI 助理的人物設定。
`BOT_TONE` | `''` | AI 助理的回覆語氣。
...
回到 [LINE](https://developers.line.biz/zh-hant/) 平台，修改「Webhook URL」，例如「<https://0000-0000-0000.jp.ngrok.io/webhook>」，點選「Update」按鈕。
